    ...
    <footer className="relative bg-[var(--bg)] pt-32 pb-12 overflow-hidden border-t border-white/5">
      ...
      <Container className="relative z-10 text-center">
        ...
        >
          ...
          <motion.p
            variants={fadeUpPremium}
            className="text-center text-xl md:text-2xl text-[var(--text-muted)] mb-12 max-w-3xl mx-auto font-medium leading-relaxed"
          >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">
        ...
        <div className="mt-16 pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--text-muted)] opacity-60">
