      ...
      <Container className="relative z-20 text-center pt-20">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-8xl font-black leading-[1.1] mb-6 text-white tracking-tighter"
          >
          ...
          <motion.p
            variants={fadeUpPremium}
            className="text-lg md:text-2xl text-[var(--text-muted)] max-w-2xl mx-auto mb-12 leading-relaxed font-medium"
          >
          ...
          {/* CTA */}
          <motion.div variants={fadeUpPremium} className="flex flex-col items-center gap-5">
            <Button
              variant="primary"
              size="xl"
              onClick={() =>
